...
const DEMO_DATA = [
  {
    ...
    content:
      "This is a great tour. I have been to many, and this is by far the best. I can't recommend this tour enough!",
  },
  {
    id: 2,
    ...
    content:
      "The service was excellent. I highly recommend this tour!",
  },
  {
    id: 3,
    ...
    clientAddress: "Tokyo",
    content:
      "The guide was very helpful. The tour was amazing!",
  },
];
...
const SectionClientSay: FC<SectionClientSayProps> = ({
  ...
  return (
    <div className={`nc-SectionClientSay relative ${className} `}>
      <Heading desc="Let's see what people think of WalkWise" isCenter>
